// Актуализация каталога + UI cleanup loader. v13.16
(function(){
  ...
  const SPAROHOD_PATCH={
    ...
    desc:'Банный SPA-комплекс у пристани на Ялтинской, 66 к19. В актуальных источниках подтверждаются баня, сауна, SPA-формат и бассейн; стоимость зависит от выбранной программы.'
  };
  const NUMBERED_BATHS_PATCH={
    ...
    phone:'+74012755555',
    source:'Официальный сайт Суворовской бани',
  ...
  // Основной телефон для звонка. Существующие старые значения намеренно заменяются
  // на выбранный после сверки номер, чтобы не было конфликтующих слоёв данных.
  const PHONE_UPDATES={
    'Бордо':'+79114502013',
    'У озера':'+79527981495',
    'Котбус':'+74012585888',
  ...
  // 101sauna подтверждает карточку, но скрывает сами цифры номера.
